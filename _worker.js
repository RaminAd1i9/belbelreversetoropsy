...
let userID = 'f9d4feed-8795-44ab-a24a-55d0318a137a';

let proxyIP = ['ircpipproxy.duckdns.org', 'cogentcomm.biz', 'alibabagroup.com', 'skk.moe', 'constant.com'];
...
const cn_hostnames = [
	'cloudflare-reverse-proxy.pages.dev/proxy/https://api.telegram.org',      // The Telegraph - A British newspaper website
];